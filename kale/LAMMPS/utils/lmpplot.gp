...
DF="case1.log"    # LAMMPS log file name
...
set xtics format "%.0f" 
set origin 0.0,MPYO; 
plot DF using 1:2 'ec %lf %lf %lf %lf %lf %lf' with lp lw LW lt rgb "blue"  pt 7 ps PS title "Temp"

set xtics format ""
set origin 0.0,MPDY+MPYO;
plot DF using 1:3 'ec %lf %lf %lf %lf %lf %lf' with lp lw LW lt rgb "red"   pt 7 ps PS title "Epot"

set xtics
set origin 0.0,2*MPDY+MPYO;
plot DF using 1:4 'ec %lf %lf %lf %lf %lf %lf' with lp lw LW lt rgb "green" pt 7 ps PS title "Etot"

set xtics
set origin 0.0,3*MPDY+MPYO;
plot DF using 1:5 'ec %lf %lf %lf %lf %lf %lf' with lp lw LW lt rgb "cyan"  pt 7 ps PS title "Press"

set xtics
set origin 0.0,4*MPDY+MPYO
plot DF using 1:6 'ec %lf %lf %lf %lf %lf %lf' with lp lw LW lt rgb "black"  pt 7 ps PS title "Vol"
